...
/*!****************************!*\
  !*** ./js/collapsibles.js ***!
  \****************************/
/*! exports provided: initCollapsibles */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCollapsibles", function() { return initCollapsibles; });
var initCollapsibles = function initCollapsibles() {
  if (document.querySelector('[data-hidden-content="info"]')) {
    var hiddenContent = document.querySelector('[data-hidden-content="info"]');
    var showButton = document.querySelector('[data-show-content="info"]');
    var isOpen = false;
  ...
  if (document.querySelector('[data-hidden-footer]')) {
    ...
    var showButtonArray = document.querySelectorAll('[data-show-footer]');
    var hiddenTextArray = document.querySelectorAll('[data-hidden-footer]');
    var breakpoint = window.matchMedia('(max-width:767px)');
    hiddenTextArray.forEach(function (block) {
      block.classList.add('is-closed-mobile');
    });
    showButtonArray.forEach(function (button) {
      var id = button.getAttribute('data-show-footer');
      var hiddenText = document.querySelector('[data-hidden-footer=' + CSS.escape(id) + ']');
        ...
        if (breakpoint.matches) {
          if (hiddenText.classList.contains('is-closed-mobile')) {
            if (accordionOpen) {
              ...
              showButtonArray.forEach(function (element) {
...
/* harmony import */ var _collapsibles_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./collapsibles.js */ "./js/collapsibles.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_scroll_js__WEBPACK_IMPORTED_MODULE_3__["scrollForm"])();
  });
  Object(_collapsibles_js__WEBPACK_IMPORTED_MODULE_4__["initCollapsibles"])();
});
  ...
  _createClass(Form, [{
    ...
    value: function _initValidate(parent) {
      ...
      phoneParents.forEach(function (item) {
        return _this3._initPhoneInput(item);
      });
      form.noValidate = true;
      form.addEventListener('submit', function (event) {
        event.preventDefault();
        if (_this3.validateForm(event.target)) {
          form.submit();
        }
      });
      form.addEventListener('input', function (event) {
        _this3._onFormInput(event.target);
      });
    ...
    value: function init() {
      ...
      this._validateParent.forEach(function (parent) {
        return _this4._initValidate(parent);
      });
    }
  }]);
  return Form;
...
var scrollForm = function scrollForm() {
  if (document.querySelector('[data-scroll-to="form"]')) {
    var form = document.querySelector('[data-scroll="form"]');
    document.querySelector('[data-scroll-to="form"]').addEventListener('click', function () {
      form.scrollIntoView({
        behavior: 'smooth',
        block: 'center'
      });
